              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  ...
                  <div class="d-flex">
                    ...
                    <p class="text-primary mb-0 hover-cursor">Brins Table</p>
                  </div>
                </div>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Brins <b>Details</b></h2></div>
                    <div class="col-sm-4">
			...
			<button id="addBtn">Ajouter Brin en cours d'utilisation</button>
            <table class="table table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        <th>Brin N°<i class="fa fa-sort"></i></th>
			<th>Etat</th>
                        <th>Ligne ID</th>
