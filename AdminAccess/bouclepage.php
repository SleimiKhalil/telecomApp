              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  ...
                  <div class="d-flex">
                    ...
                    <p class="text-primary mb-0 hover-cursor">Boucles Table</p>
                  </div>
                </div>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Boucles <b>Details</b></h2></div>
                    <div class="col-sm-4">
            ...
            <table class="table table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        <th>Boucle ID <i class="fa fa-sort"></i></th><!-- If there is any meaning to it-->
                        <th>CTN Départ</th>
