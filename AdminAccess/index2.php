...
<?php
  session_start();
  //$hostname = "mysql:host=127.0.0.1;port=3308;dbname=telecom;charset=utf8" ;
	$conn = mysqli_connect("127.0.0.1","root","","telecom");
	
  //$conn = mysqli_connect("127.0.0.1:3308","root@localhost","JustDoIt3301","telecom");
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="index.html"><img src="images/00-logo-tt-thumb.png" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/00-logo-tt-thumb.png" alt="logo"/></a>
        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="index.html">
              ...
              <span class="menu-title">View / Mange Clients</span>
            </a>
          </li>
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  ...
                  <div class="d-flex">
                    ...
                    <p class="text-primary mb-0 hover-cursor">Clients Table</p>
                  </div>
                </div>
    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        <th>Ligne ID <i class="fa fa-sort"></i></th>
                        <th>Demand Réf.</th>
                        
                        <th>Client Name</th>
                        <th>Itinerary<i class="fa fa-sort"></i></th>
                        <th>Brin</th>
                        <th>Date of commissioning<i class="fa fa-sort"></i></th>
                        <th>Addresse</th>
                        <th> </th>
                    </tr>
                </thead>
